...
function my_script_init() {
    ...
    wp_enqueue_script("loading-js", get_template_directory_uri() . "/assets/js/loading.min.js", array("jquery"), filemtime(get_theme_file_path('/assets/js/loading.min.js')), true);
